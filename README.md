...
mutations likely due to misfolding*. Due to data licensing restrictions
(see Data availability notice), full reproduction requires independently
obtaining the necessary DisGeNET data.
