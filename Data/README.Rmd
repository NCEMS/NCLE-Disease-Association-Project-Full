...
Note: This file is not included in this repository due to the data restrictions described above related to DisGeNET’s user agreement.
...
- `final_resultsRAW05_21_2024.csv `(diseaseClasses_MSH, score, disease_name, diseaseUMLSCUI, protein_class_name, protein_classid, EntreID/geneid)
...
- `final_dfA02_22_2026.csv` (uniprotids, score, Entanglement, Cov_Entanglement, Knot)
